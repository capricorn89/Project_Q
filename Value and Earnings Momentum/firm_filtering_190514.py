...
#
rebalDataFinal.to_excel('firms_190514.xlsx', index = False)    
rebalDataFinal_k200.to_excel('firms_190514_k200.xlsx', index = False)    
#    
...
basket_190514 = mergeK200Weight(rebalDataFinal_k200, k200Weight, sector, sectorOn=True)
newpath = path + '/res'
os.chdir(newpath)
basket_190514.to_excel('basket_190514.xlsx', index = False)
